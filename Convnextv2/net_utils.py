...
class FeatureRectifyModule(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # out_x1 = self.lambda_c * channel_weights[1] * x2 + self.lambda_s * spatial_weights[1] * x2
        # out_x2 = self.lambda_c * channel_weights[0] * x1 + self.lambda_s * spatial_weights[0] * x1
